...
<head>
    ...
    <title>Data Iuran RT 007</title>
    <link rel="stylesheet" href="/css/bootstrap.min.css">
</head>
<body>
    <div class="container">
    <br><h3>Data Iuran RT 007</h3>
 <b>
 ...
 <br>
     Laporan Total Keuangan Masuk: <?php echo " Rp.". number_format($gettotal).",00"; ?>
    </b> 
        <table class="table table-striped">
            <thead>
                <tr>
                    <th>Nama Pembayar Iuran</th>
                    <th>Nominal</th>
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="product_name" placeholder="Nama Pembayar">
                </div>
                 
                <div class="form-group">
                    <label>Nominal</label>
                    <input type="text" class="form-control" name="product_price" placeholder="Nominal">
                </div>
    ...
    <form action="/product/update" method="post">
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label>Nama Pembayar</label>
                    <input type="text" class="form-control product_name" name="product_name" placeholder="Nama Pembayar">
                </div>
                 
                <div class="form-group">
                    <label>Nominal</label>
                    <input type="text" class="form-control product_price" name="product_price" placeholder="Nominal">
                </div>
